...
describe('URI', function () {
  ...
  it('parses uri strings correctly (test vector)', function () {
    ...
    uri = URI.parse('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    uri.address.should.equal('MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    expect(uri.amount).to.be.undefined;
    expect(uri.otherParam).to.be.undefined;

    uri = URI.parse('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=123.22');
    uri.address.should.equal('MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    uri.amount.should.equal('123.22');
    expect(uri.otherParam).to.be.undefined;

    uri = URI.parse(
      'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=123.22' +
  ...
  it('URIs can be validated statically (test vector)', function () {
    URI.isValid('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg').should.equal(true);
    URI.isValid('dash:mRRak39Y7rLPaduabKPCveiUt8cW6E6C8J').should.equal(true);

    URI.isValid(
      'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=1.2'
    ).should.equal(true);
    URI.isValid(
      'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=1.2&other=param'
    ).should.equal(true);
    URI.isValid(
      'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=1.2&req-other=param',
      ['req-other']
    ).should.equal(true);
    URI.isValid(
      'dash:mNXEF51fm2CBDVVW2PUg5miCTG4uK7yk1z?amount=0.1&' +
  ...
  it('do not need new keyword', function () {
    var uri = URI('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
  ...
  describe('instantiation from bitcoin uri', function () {
    ...
    it('parses address', function () {
      uri = new URI('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    ...
    it('parses amount', function () {
      ...
      uri.address.toString().should.equal('MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
      uri.amount.should.equal(12322000000);
      expect(uri.otherParam).to.be.undefined;
    });

    it('parses a testnet address', function () {
      uri = new URI('dash:mRRak39Y7rLPaduabKPCveiUt8cW6E6C8J');
      uri.address.should.be.instanceof(bitcore.Address);
  ...
  it('should create instance from object', function () {
    ...
    uri = new URI({
      address: 'mRRak39Y7rLPaduabKPCveiUt8cW6E6C8J',
    });
    uri.address.should.be.instanceof(bitcore.Address);
    uri.network.should.equal(Networks.testnet);
  ...
  it('should support double slash scheme', function () {
    var uri = new URI('dash://MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    uri.address.toString().should.equal('MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
  });

  it('should input/output String', function () {
    var str =
      'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?' +
  ...
  it('should support numeric amounts', function () {
    var uri = new URI(
      'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=12.10001'
    );
  ...
  it('should generate a valid URI', function () {
    new URI({
      ...
      .toString()
      .should.equal('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    ...
    new URI({
      ...
      .toString()
      .should.equal(
        'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg?amount=1.10001&message=Hello%20World&something=else'
      );
  });

  it('should be case insensitive to protocol', function () {
    var uri1 = new URI('DaSh:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
    var uri2 = new URI('dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg');
  ...
  it('displays nicely on the console (#inspect)', function () {
    var uri = 'dash:MEfwVPUDkeY4pVpK3McS93mggPs7YG1wmg';
