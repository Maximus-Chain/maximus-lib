  ...
  beforeEach(() => {
    ...
    object = {
      inputs: [
        {
          outpointHash:
            'e61ac337df297d26f7a487e3697378b1499eef66e86fc4c92037e616ff93443c',
          outpointIndex: 1,
        },
      ],
      txid: '0658b89693b62e68a293d9cd6c6571c3b291aa29b4ee65825c0d14ddba26069a',
      signature:
        '879660757405ddc5dbb88d6366333032b901101b9bc3bff47d1d48189645a3ec8757142e749fa885ddf293817d669e4e12650b0d1c2111e4f98e2613e59ba09cf60f29c31260c9fc12a77f92ecfb5d22e36678808193052c5b71a2b659a2642c',
    };
    ...
    object2 = {
      inputs: [
        {
          outpointHash:
            '0658b89693b62e68a293d9cd6c6571c3b291aa29b4ee65825c0d14ddba26069a',
          outpointIndex: 0,
        },
      ],
      txid: '8b51b1f0d969201ec90d600e8be28411ddce53624f4dffac0737c5d4a52a5b3a',
      signature:
        'b375c32bdb9a66a8b869abd20ca28b92f08fede20577e9f5edd5b1f122747e2afb375a07749a7c8db56c40636bfa5fc5099788852cfbebf8999faf079061988320363fbdca9024afdcd0b11f622ffa8d7edb285c11f4d4c76c072950ac3eab1c',
    };
    ...
    quorumEntryJSON = {
      ...
      llmqType: 104,
      quorumHash:
        '79aa3c3d5ff180aa6d200d78785894466190d4421eef3d86f442dde4257f1725',
      quorumIndex: 0,
      signersCount: 3,
      signers: '07',
      validMembersCount: 3,
      validMembers: '07',
      quorumPublicKey:
        'aaca742e2c94a1e216d96cb7de81089130954599ec987a47c272c1ae97aa17953b619b03b7b1a39f5ce6a17b1a1e583a',
      quorumVvecHash:
        '963ea8d183225dac6696009e789b0913c435093ea4eea3444c8ff5318cbb73fd',
      quorumSig:
        '85714c17dac8d6f6161d4894a56a8f014887e7755c4bf48f34c83e71ba8ea80bba3670489b37a6db7085ac83cb504ee90a08127e4958686fede397e8a2a3e4edc86bf760dcce184bfdcb93334500023373fbbcfa468b8c79e4c6274f11362d7f',
      membersSig:
        'b5d9563394f90a2526de899619137c8dd4a17c5f42767f4bd5e32446105f10adf0eb5df9cc47f9b96d94269e2e759a3007374ae1f9285e4f7f7ca2458aa486c90d2d2d19ba75f9ad3667e0d528603f6ec755660b3733c6c7bebf7d1863bf7388',
    };
    ...
    instantLockJSONFromTestNet = {
      ...
      cyclehash:
        '49ba70a3fc159ee138a9de44525c52cb13b14017e083b73f2cd414f15a5667e7',
      signature:
  ...
  describe('validation', function () {
    ...
    describe('#verify', function () {
      it('should verify signature against SMLStore', async function () {
        const instantLock = new InstantLock(Buffer.from(str, 'hex'));
      ...
      it('should not crash if BLS fails to parse the signature or any other data', async function () {
        const instantLock = new InstantLock(
          Buffer.from(
            '',
            'hex'
          )
        );
      ...
      it('should verify instant lock past the height in sml store', async function () {
        ...
        const instantLock = InstantLock.fromBuffer(
          Buffer.from(
            '',
            'hex'
          )
        );
  ...
  describe('computation', function () {
    ...
    describe('selectSignatoryNonRotatedQuorum', () => {
      it('should select signatory for non rotated quorum', () => {
        ...
        const result = instantLock.selectSignatoryQuorum(
          SMLStore,
        ...
        expect(result.llmqType).to.be.equal(
    ...
    describe('selectSignatoryRotatedQuorum', () => {
      it('should select signatory for rotated quorum', () => {
        ...
        const offset = 8;
        const isBufHex =
          '';
        ...
        expect(result).to.be.an.instanceof(QuorumEntry);
        expect(result.quorumHash).to.be.equal(
          '00000084db75bc85dc66d6fd7f569283415b06afc4a5d33e746b96470339359b'
        );
        expect(result.llmqType).to.be.equal(
    ...
    describe('instantiation', () => {
      describe('#fromBuffer', () => {
        ...
        it('should be able to handle false-positive v18', () => {
          const instantLockString =
            '';
          const instantLockObject = {
            inputs: [
              {
                outpointHash:
                  'b780ff80f5101e389b38519d575ada2efff5ef1ed9725253c6a7cbf63df8ed04',
                outpointIndex: 1,
              },
            ],
            txid: '22a10af3f68f03a1509579cf7dbc4fa833c01272dbe02f42995610667bcc484d',
            signature:
              '0291fcfb6d44c06780ac475ce5cb3dd4c7f565888f485252cb4ae6ad206161b2f58655752c8e74f5ef627813870e94490fa7c1634361054fb1b81dd751a9dcd8419dc00dd17282729c474ecf4aae9053dbbcc43e02710f8f899db38be8d649e5',
          };
