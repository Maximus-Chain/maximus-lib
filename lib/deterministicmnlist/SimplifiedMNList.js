 ...
 */
SimplifiedMNList.prototype.isLLMQTypeRotated = function isLLMQTypeRotated(
  llmq
) {
  return (
    llmq === constants.LLMQ_TYPES.LLMQ_DEVNET_DIP0024 ||
...
SimplifiedMNList.prototype.calculateScores = function calculateScores(
  ...
  return this.validMNs
    ...
    .filter((mn) =>
      onlyHighPerformanceMasternodes ? mn.nType === MASTERNODE_TYPE_HP : true
    )
    .map((mn) => {
